  ...
  return (
    <div>
      <Title
        ...
        font="outfit"
        title="Dashboard"
        subTitle="Monitor Your Room Listings , Track Bokkings and Analyze revenue-all in one place.Stay updated with real-time insights to ensure smooth operations."
      />
